...
export default function Skills() {
  return (
    ...
    >
      ...
      <h1 className="text-7xl font-thin text-gray-200">Skills</h1>
      ...
      <div className="text-2xl font-thin text-gray-200 gap-12">
        ...
        <a href="https://credly.com/users/glass-ships/badges" target="_blank" rel="noopener noreferrer" className="text-yellow-400 text-bold">
          here
        </a>
        .
        <br />
      ...
      >
        {[
          ...
          },
          {
            title: "Git",
            description:
              "Version control and code management is a must for any software project. I use Git for all of my Projects, and I'm comfortable with the command line and GitHub as well as GitLab.",
            icon: faCodeBranch,
          },
          {
          ...
          <div
            ...
            className="
                    ...
                    "
          >
            <Icon icon={skill.icon} size="4x" className="text-yellow-400  bg-slate-700 shadow-black shadow-lg rounded-full p-4" />
            <div className="grid grid-col items-center justify-center gap-4 ">
              <h1 className="text-3xl  font-thin text-gray-200">{skill.title}</h1>
