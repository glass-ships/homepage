      ...
      >
        {
          ...
          [
            ...
            },
            {
              title: "LinkML",
              description:
                "LinkML is a language for describing data models, including generators for schema representations in several languages and formats. I contribute to several aspects of the project, including documentation, bug fixes, and new features for Python, Typescript, and other generators.",
            ...
            <div
              ...
              className="
                        ...
                        bg-zinc-800/20 shadow-xl rounded-xl
            ...
            >
              <div className="flex flex-col items-center justify-center gap-4">
                <h1 className="text-3xl font-thin text-gray-200">{project.title}</h1>
                <p className="text-xl font-thin text-gray-200">{project.description}</p>
              </div>
              <a
                href={project.link}
                target="_blank"
