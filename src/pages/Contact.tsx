  ...
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center gap-8 snap-center">
        ...
        <form className="flex flex-col gap-4 w-[75%] h-3/4 text-slate-300  shadow-xl" action="https://formspree.io/f/moqpzbzj" method="POST">
          ...
          <button className="text-xl p-2 bg-amber-200 text-black" type="submit">
            Send
          </button>
        </form>
      </div>
