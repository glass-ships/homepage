...
export const cos = (degrees = 0): number => Math.cos((2 * Math.PI * degrees) / 360);
...
/** translate a point */
export const translate = (point: Point3d, offset: Point3d, scale = 1): Point3d => ({
...
export const project = (point: Point3d, xAngle = 0, yAngle = 0, offsetX = 0, offsetY = 0): Point2d => {
