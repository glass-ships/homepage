  ...
  return (
    <AppSection id="about" width="big">
      <AppCard>
          ...
          <p>
            Currently, I work at&nbsp;
            <a href="https://neutrons.ornl.gov" target="_blank" rel="noopener noreferrer">Oak Ridge National Lab</a>, where I develop analysis software, web apps,
            and infrastructure for one of the world's leading neutron science research facilities.
          </p>
          <p>
            When I'm not at work, I enjoy making music, gaming, developing and contributing to open-source projects,<br />
