...
const skills = [
  {
    title: "Python",
    description: `Python is one of the most popular languages for scientific computing,
      owing to its ease of use and large ecosystem of libraries.
      It's my go-to language for scientific software development.`,

    icon: "python",
  },
  {
    title: "Git",
    description: `Version control and code management are a must for any software project.
      I use Git for all of my projects, and I'm comfortable with the git CLI, and GitHub as well as GitLab.`,
    icon: "code-branch",
  },
  {
    title: "Cloud Computing",
    description: `I've worked with cloud computing platforms such as AWS and GCP,
      and I'm familiar with the basics of cloud computing and deployment.
      I'm also familiar with Docker and containerization.`,
    icon: "cloud-arrow-up",
  },
  {
  ...
  {
    title: "Data Analysis",
    description: `I've worked with a variety of data analysis tools, including Pandas, NumPy, and Matplotlib.
      I'm also familiar with data analysis techniques such as statistics and computational analysis.`,
